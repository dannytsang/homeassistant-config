...
- `COMMIT-CONVENTIONS.md` - 🚨 IRON CLAD LAW: No Claude attribution in commits
...
|------|---------|-----------|
| `COMMIT-CONVENTIONS.md` | 🚨 No Claude attribution - iron clad law | Before making any commits |
...
1. **User mentions specific room** → Load that room's setup documentation if it exists
2. **User asks to validate/review** → Load ha-yaml-quality-reviewer.md
3. **User reports error** → Check ha-known-error-detector.md for pattern match
4. **User mentions consolidation** → Load ha-consolidation-analyzer.md
5. **First of month** → Suggest loading reflection context
6. **User mentions "continue"** → Load project status files to understand ongoing work
...
- Current error rate (30% → improving)
...
- "Read this file to understand the strategy" → Point to `.claude/README.md`
- "What should I load for this task?" → Check the task-specific section above
- "Where is X documentation?" → Check the directory structure
