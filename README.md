...
### Statistics 📊
I have 7,271 states states in Home Assistant. More details are in [statistics.md](statistics.md), and YAML package counts are tracked in [setup_statistics.md](setup_statistics.md).
